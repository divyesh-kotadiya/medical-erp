...
export default function Dashboard() {
  ...
  const stats = [
    ...
    { title: "Today's Shifts", value: shifts?.length || 0, change: '12 remaining', icon: Calendar, color: 'text-purple-600' },
    { title: 'Hours This Week', value: '2,847', change: '+12% vs last week', icon: Clock, color: 'text-amber-600' },
            ...
            <div className="bg-card rounded-lg p-4 border border-border">
              ...
              <div className="h-48 flex items-center justify-center">
                <div className="relative w-40 h-40 rounded-full flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 rounded-full border-8 border-warning" style={{ clipPath: 'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%)' }}></div>
                  ...
                  <div className="absolute inset-0 rounded-full border-8 border-lime-500" style={{ clipPath: 'polygon(50% 50%, 0% 50%, 0% 0%, 50% 0%)' }}></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border border-border shadow-card">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-muted-foreground">Latest actions from your team members</CardDescription>
          </CardHeader>
              ...
              <div key={item} className="flex items-center justify-between p-3 rounded-lg bg-secondary/50 hover:bg-secondary transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Completed shift in Department {item}</p>
