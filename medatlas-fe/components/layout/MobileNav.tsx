...
export default function MobileNav() {
  ...
  const links = [
    ...
    { href: '/scheduling', label: 'Scheduling', icon: <Calendar className="w-5 h-5 mr-2" /> },
    { href: '/timesheets', label: 'Timesheets', icon: <Clipboard className="w-5 h-5 mr-2" /> },
    { href: '/incidents', label: 'Incidents', icon: <AlertCircle className="w-5 h-5 mr-2" /> },
    { href: '/documents', label: 'Documents', icon: <FileText className="w-5 h-5 mr-2" /> },
    { href: '/reports', label: 'Reports', icon: <BarChart className="w-5 h-5 mr-2" /> },
